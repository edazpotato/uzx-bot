...
var CommandClient = /** @class */ (function () {
    ...
    CommandClient.prototype.WebSocketHeartbeat = function () {
        ...
        this.ws.send(JSON.stringify({ op: 1, d: this.lastHeartbeatSequenceNumber }));
        this.WebSocketHeartbeatTimeout = setTimeout(function () {
    ...
    CommandClient.prototype.handleEvent = function (name, data) {
        console.log(name + " event received from Discord!", data);
    };
    CommandClient.prototype.connectWebSocket = function () {
        clearTimeout(this.WebSocketHeartbeatTimeout);
    ...
    CommandClient.prototype.start = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __1.authenticatedDiscordAPIRequest("/gateway/bot", {}, this.token)
                    ...
                    case 1:
                        ...
                        this.ws.on("message", function (rawData) {
                            try {
                                ...
                                if (sequenceNumber)
                                    _this.lastHeartbeatSequenceNumber = sequenceNumber;
                                switch (opCode) {
                                    case 0:
                                        /* Opcode 0: Dispatch */
                                        /* The client has recived an event from Discord! */
                                        _this.handleEvent(eventName, eventData);
                                        break;
                                    case 1:
                                        /* Opcode 1: Heartbeat */
                                    ...
                                    case 10:
                                        ...
                                        _this.lastHeartbeatAcknowledged = true;
                                        _this.WebSocketHeartbeatTimeout = setTimeout(_this.WebSocketHeartbeat, _this.heartbeatInterval * Math.random());
                                        _this.ws.send(JSON.stringify({
                                            ...
                                            d: {
                                                ...
                                                properties: {
                                                    $os: process.platform,
                                                    $browser: "UZX Slash Commands framework",
                        ...
                        this.ws.on("close", function () { return clearTimeout(_this.WebSocketHeartbeatTimeout); });
                        return [2 /*return*/];
                }
            });
        });
